...
public class LibreOfficeLauncherHelper {
  ...
  /**
   * Generates the open url for libre office, should be the same on all
   * operating systems
   * 
   * @param cmisUrl
   *          The cmis url
   * @param repositoryId
   *          The repository id of the content reposiotory on the CMIS server
   * @param filePath
   *          The path to the file to open on the CMIS server
   * @return
